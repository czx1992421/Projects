#Find the most retweeted original tweet by connecting to Twitter API and certain hashtag
...
#The most retweeted original tweet
...
for i in range(0,len(tweets)):
      if retweet_count[i] == max(retweet_count):
        ...
        print 'The most retweeted original tweet:',tweet_most_retweeted['text']
